...
public class GroundOverlayDemoActivity extends AppCompatActivity
    ...
    private static final LatLng NEWARK = new LatLng(39.039136, -94.570301);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        mImages.clear();
        mImages.add(BitmapDescriptorFactory.fromResource(R.drawable.userdev));
        mImages.add(BitmapDescriptorFactory.fromResource(R.drawable.address));
